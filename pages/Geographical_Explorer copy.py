...
# #     """Create an interactive choropleth for selecting countries."""
# #     if all_names_df.empty:
# #         return go.Figure()

# #     aggregated = (
# #         all_names_df.groupby("country", observed=True)[
...
# #         ]
# #         top_name_lookup[country] = "<br>".join(lines) if lines else "No data"

# #     hover_text = []
# #     for _, row in aggregated.iterrows():
# #         country = row["country"]
# #         total = int(row["count"])
# #         top_section = top_name_lookup.get(country, "No data available")
# #         hover_text.append(
# #             "<b>{}</b><br>Total names counted: {:,}<br><br><b>Top names:</b><br>{}".format(
# #                 country, total, top_section
# #             )
# #         )
...
# #         marker=dict(line=dict(color="#f7f7f7", width=0.6)),
# #         zmin=aggregated["count"].min(),
# #         zmax=aggregated["count"].max(),
# #     )
...
# #                     featureidkey="properties.name",
# #                     colorscale=[[0, "rgba(255,107,107,0.75)"], [
# #                         1, "rgba(255,107,107,0.75)"]],
# #                     showscale=False,
# #                     hoverinfo="skip",
# #                     marker=dict(line=dict(color="#ff6b6b", width=2)),
# #                 )
# #             )
...
# #                 margin={"r": 0, "t": 0, "l": 0, "b": 0}, showlegend=False, height=620, paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)'
# #             )
